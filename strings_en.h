...
"<form action='/wifi'    method='get'><button>Configure Device WiFi</button></form><br/>\n", // MENU_WIFI
...
"button,input[type='button'],input[type='submit']{cursor:pointer;border:0;background-color:#d00409;color:#fff;line-height:2.4rem;font-size:1.2rem;width:100%}"
...
".h{display:none}"
"button.D{background-color:black}"
// invert
"body.invert,body.invert a,body.invert h1 {background-color:transparent;color:black;}"
"body.invert .msg{color:#fff;background-color:#282828;border-top:1px solid #555;border-right:1px solid #555;border-bottom:1px solid #555;}"
"body.invert .q[role=img]{-webkit-filter:invert(1);filter:invert(1);}"
"body{background: linear-gradient(270deg, #7ab5e4, #c4ddec);margin: 4px;}"
"html{background: url('https://karthikairasu.github.io/Ansara_training_institute/assets/images/border.png');}"
